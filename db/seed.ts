import { db, Himnos, Jovenes } from 'astro:db';

// https://astro.build/db/seed
export default async function seed() {
  // Insert hymns without specifying id
  await db.insert(Himnos).values([
    {
      titulo: 'Es un gozo inefable',
      letra: `Encontramos a Cristo el Señor,
...
Nuestra vida llena está.`,
    },
    {
      ...
      letra: `Bebe! Fluye un río desde el trono del Señor;
...
En la localidad.`,
  ...
  // Insert entries for Jovenes hymnal
